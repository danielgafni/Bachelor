...
\begin{center}
\begin{tabular}{ccc}
D. Gafni \textsuperscript{a\textasteriskcentered} & D.V. Nekhaev \textsuperscript{b} & V.A. Demin \textsuperscript{b} \\
\end{tabular}
...
\begin{flushleft}
 \begin{tabularx}{\textwidth}{lm{10cm}}
  \textbf{Funding} & {This work was partially supported by the Russian Science Foundation (project № 20-79-10185) in the studying of inhibitory connections training and by the grant INSERT NAME in the part of comparison of convolгtional and locally connected achitectures.} \\
